...
// We subtract the padding (16*2) and the gap (16)
                    val maxTwoColumnWidth = (screenWidth - 48.dp) / 2
                    ...
                    if (uiState.filteredRecipes.isNotEmpty()) {
                        LazyVerticalStaggeredGrid(
                            ...
                            columns = StaggeredGridCells.Adaptive(minSize = minOf(160.dp, maxTwoColumnWidth)),
                            content = {
