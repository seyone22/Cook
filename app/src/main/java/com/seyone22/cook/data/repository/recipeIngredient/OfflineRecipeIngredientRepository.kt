...
class OfflineRecipeIngredientRepository(private val recipeIngredientDao: RecipeIngredientDao):
    ...
    override suspend fun getRecipeIngredientsForRecipe(recipeId: UUID): Flow<List<RecipeIngredient?>> = recipeIngredientDao.getRecipeIngredientsForRecipe(recipeId)
    override suspend fun getAllRecipeIngredients(): Flow<List<RecipeIngredient?>> = recipeIngredientDao.getAllRecipeIngredients()
    override suspend fun deleteIngredientsForRecipe(recipeId: UUID) = recipeIngredientDao.deleteIngredientsForRecipe(recipeId)
